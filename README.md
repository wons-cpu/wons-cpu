...
- AI Engineering Intern @ **DeepHigh** (Seoul) — NLP sentiment analysis, emoji recommendation models, 19% accuracy improvement.
- **ValueCell AI Trader** — Hackathon project: full-stack trading analysis platform with Python FastAPI + Next.js.

### Stack

`Java` `Python` `JavaScript` `C++` `Kotlin` `React` `Next.js` `FastAPI` `Git` `Android Studio` `HISE` `Logic Pro`

---

*Composer, sound designer, vocalist in [OSCAR Band](https://github.com/wons-cpu). Building things that sound as good as they work.*
